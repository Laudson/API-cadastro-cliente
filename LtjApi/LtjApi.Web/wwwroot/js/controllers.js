 ...
 * Define controllers with data used in LtjApi theme
 *
 *
...
function notifyCtrl($scope, notify) {
    ...
    $scope.LtjApiTemplate = 'views/common/notify.html';
    $scope.LtjApiDemo1 = function(){
        notify({ message: 'Info - This is a LtjApi info notification', classes: 'alert-info', templateUrl: $scope.LtjApiTemplate});
    }
    $scope.LtjApiDemo2 = function(){
        notify({ message: 'Success - This is a LtjApi success notification', classes: 'alert-success', templateUrl: $scope.LtjApiTemplate});
    }
    $scope.LtjApiDemo3 = function(){
        notify({ message: 'Warning - This is a LtjApi warning notification', classes: 'alert-warning', templateUrl: $scope.LtjApiTemplate});
    }
    $scope.LtjApiDemo4 = function(){
        notify({ message: 'Danger - This is a LtjApi danger notification', classes: 'alert-danger', templateUrl: $scope.LtjApiTemplate});
    }
}
...
function toastrCtrl($scope, toaster){
    ...
    $scope.demo1 = function(){
        toaster.success({ body:"Hi, welcome to LtjApi. This is example of Toastr notification box."});
    };
